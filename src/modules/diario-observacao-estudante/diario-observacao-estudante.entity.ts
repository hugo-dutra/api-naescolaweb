...
export class DiarioObservacaoEstudante extends BaseEntity {
  ...
  doe_data: Date;
  /* RELACIONAMENTOS */
  @ManyToOne(type => Estudante, estudante => estudante.diariosObservacoesEstudantes, { eager: false })
  @JoinColumn({ name: 'est_id_int' })
  estudante: Estudante;
  @ManyToOne(type => DiarioProfessor, diarioProfessor => diarioProfessor.diariosObservacoesEstudantes, { eager: false })
