...
export class UsuarioEscola extends BaseEntity {
  ...
  /* RELACIONAMENTOS */
  @ManyToOne(type => PerfilUsuario, perfilUsuario => perfilUsuario.usuariosEscolas, { eager: false })
  @JoinColumn({ name: 'pru_id_int' })
  perfilUsuario: PerfilUsuario;
  @ManyToOne(type => Usuario, usuario => usuario.usuariosEscolas, { eager: false })
  @JoinColumn({ name: 'usr_id_int' })
  usuario: Usuario;
  @ManyToOne(type => Escola, escola => escola.usuariosEscolas, { eager: false })
